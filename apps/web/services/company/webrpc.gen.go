...
func WebRPCSchemaHash() string {
	return "143e460a1bd315c65968140fcf09c209c3f00aa0"
}
...
type CompanyService interface {
	GetCurrent(ctx context.Context) (*Company, error)
}
...
func NewCompanyServiceServer(svc CompanyService) WebRPCServer {
	return &companyServiceServer{
		CompanyService: svc,
	}
}

func (s *companyServiceServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	ctx = context.WithValue(ctx, HTTPResponseWriterCtxKey, w)
	ctx = context.WithValue(ctx, HTTPRequestCtxKey, r)
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "CompanyService")
	...
	switch r.URL.Path {
	case "/rpc/CompanyService/GetCurrent":
...
func (s *companyServiceServer) serveGetCurrent(ctx context.Context, w http.ResponseWriter, r *http.Request) {
...
func (s *companyServiceServer) serveGetCurrentJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.CompanyService.GetCurrent(ctx)
	}()
	respContent := struct {
		Ret0 *Company `json:"result"`
	}{ret0}
